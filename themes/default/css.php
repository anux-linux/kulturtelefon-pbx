...
$footer_background_color = $settings->get('theme', 'footer_background_color', 'rgba(178, 214, 202, 1)');
...
$footer_color = $settings->get('theme', 'footer_color', 'rgba(0, 0, 0, 0.3)');
...
$menu_main_background_color = $settings->get('theme', 'menu_main_background_color', 'rgba(178,214,202, 1)');
...
$menu_main_text_color = $settings->get('theme', 'menu_main_text_color', '#000');
$menu_main_text_color_hover = $settings->get('theme', 'menu_main_text_color_hover', '#024b40');
$menu_main_background_color_hover = $settings->get('theme', 'menu_main_background_color_hover', 'rgba(178,214,202, 0.5)');
...
$menu_sub_background_color = $settings->get('theme', 'menu_sub_background_color', 'rgba(178,214,202, 0.5)');
...
$menu_sub_text_color_hover = $settings->get('theme', 'menu_sub_text_color_hover', '#024b40');
$menu_sub_background_color_hover = $settings->get('theme', 'menu_sub_background_color_hover', 'rgba(178,214,202, 0.5)');
...
$logout_icon_color = $settings->get('theme', 'logout_icon_color', 'rgba(254,88,88,0.8)');
$logout_icon_color_hover = $settings->get('theme', 'logout_icon_color_hover', 'rgba(93,53,62,0.8)');
$menu_main_toggle_color = $settings->get('theme', 'menu_main_toggle_color', 'rgba(2,64,75,0.8)');
$menu_main_toggle_color_hover = $settings->get('theme', 'menu_main_toggle_color_hover', 'rgba(178,214,202,1.0)');
...
$menu_main_icon_color = $settings->get('theme', 'menu_main_icon_color', 'rgb(178,214,202)');
$menu_main_icon_color_hover = $settings->get('theme', 'menu_main_icon_color_hover', 'rgb(2,64,75)');
...
$button_border_size = $settings->get('theme', 'button_border_size', '0px');
$button_border_color = $settings->get('theme', 'button_border_color', 'rgb(254,88,88)');
$button_border_radius = $settings->get('theme', 'button_border_radius', '4px');
$button_background_color = $settings->get('theme', 'button_background_color', 'rgb(254,88,88)');
$button_background_color_bottom = $settings->get('theme', 'button_background_color_bottom', 'rgb(254,88,88)');
$button_text_font = $settings->get('theme', 'button_text_font', 'Candara, Calibri, Segoe, "Segoe UI", Optima, Arial, sans-serif');
$button_text_color = $settings->get('theme', 'button_text_color', 'rgb(255,255,255)');
$button_text_weight = $settings->get('theme', 'button_text_weight', 'bold');
$button_text_size = $settings->get('theme', 'button_text_size', '11px');
$button_border_color_hover = $settings->get('theme', 'button_border_color_hover', 'rgb(93,53,62)');
$button_background_color_hover = $settings->get('theme', 'button_background_color_hover', 'rgb(93,53,62)');
$button_background_color_bottom_hover = $settings->get('theme', 'button_background_color_bottom_hover', 'rgb(93,53,62)');
$button_text_color_hover = $settings->get('theme', 'button_text_color_hover', 'rgb(255,255,255)');
$button_icons = $settings->get('theme', 'button_icons', 'auto');
$body_icon_color = $settings->get('theme', 'body_icon_color', 'rgb(93,53,62)');
$body_icon_color_hover = $settings->get('theme', 'body_icon_color_hover', 'rgb(254,88,88)');
...
$input_border_color = $settings->get('theme', 'input_border_color', '#000000');
$input_border_color_focus = $settings->get('theme', 'input_border_color_focus', 'rgb(254,88,88)');
$input_border_color_hover = $settings->get('theme', 'input_border_color_hover', 'rgb(254,88,88)');
$input_border_color_hover_focus = $settings->get('theme', 'input_border_color_hover_focus', 'rgb(254,88,88)');
...
$login_link_text_color = $settings->get('theme', 'login_link_text_color', 'rgb(254,88,88)');
...
$login_link_text_color_hover = $settings->get('theme', 'login_link_text_color_hover', 'rgb(93,53,62)');
$login_text_color = $settings->get('theme', 'login_text_color', '#ffffff');
...
/* MENU: BEGIN ******************************************************************/
	...
	div.navbar-brand > a.navbar-brand-text {
		color: <?php echo ($_SESSION['theme']['menu_brand_text_color']['text'] != '') ? $_SESSION['theme']['menu_brand_text_color']['text'] : 'rgba(0,0,0,0.80)'; ?>;
	...
	div.navbar-brand > a.navbar-brand-text:hover {
		color: <?php echo ($_SESSION['theme']['menu_brand_text_color_hover']['text'] != '') ? $_SESSION['theme']['menu_brand_text_color_hover']['text'] : 'rgba(0,0,0,0,1.0)'; ?>;
		color: <?php echo ($_SESSION['theme']['menu_brand_text_color_hover']['text'] != '') ? $_SESSION['theme']['menu_brand_text_color_hover']['text'] : 'rgba(0,0,0,0,1.0)'; ?>;
	...
	ul.navbar-nav > li.nav-item > ul.dropdown-menu {
		...
		?>
		background: <?php echo ($_SESSION['theme']['menu_sub_background_color']['text'] != '') ? $_SESSION['theme']['menu_sub_background_color']['text'] : 'rgba(178,214,202,1.0)'; ?>;
...
/* SIDE MENU: Begin ***********************************************************/
	...
	div#menu_side_container > div#menu_side_control_container a.menu_side_item_main {
		...
		color: <?php echo ($_SESSION['theme']['menu_main_text_color']['text'] != '') ? $_SESSION['theme']['menu_main_text_color']['text'] : '#000'; ?>;
		font-family: <?php echo ($_SESSION['theme']['menu_main_text_font']['text'] != '') ? $_SESSION['theme']['menu_main_text_font']['text'] : 'arial'; ?>;
		font-size: <?php echo ($_SESSION['theme']['menu_main_text_size']['text'] != '') ? $_SESSION['theme']['menu_main_text_size']['text'] : '10.25pt'; ?>;
		color: <?php echo ($_SESSION['theme']['menu_main_text_color']['text'] != '') ? $_SESSION['theme']['menu_main_text_color']['text'] : '#000'; ?>;
		cursor: pointer;
	...
	a.menu_side_item_sub {
		...
		text-align: left;
		background: <?php echo ($_SESSION['theme']['menu_sub_background_color']['text'] != '') ? $_SESSION['theme']['menu_sub_background_color']['text'] : '#b2d6ca'; ?>;
	...
	a.menu_side_item_sub:active {
		...
		background: <?php echo ($_SESSION['theme']['menu_sub_background_color_hover']['text'] != '') ? $_SESSION['theme']['menu_sub_background_color_hover']['text'] : '#b2d6ca'; ?>;
		color: <?php echo ($_SESSION['theme']['menu_sub_text_color_hover']['text'] != '') ? $_SESSION['theme']['menu_sub_text_color_hover']['text'] : '#024b40'; ?>;
		background: <?php echo ($_SESSION['theme']['menu_sub_background_color_hover']['text'] != '') ? $_SESSION['theme']['menu_sub_background_color_hover']['text'] : '#b2d6ca'; ?>;
		text-decoration: none;
		}

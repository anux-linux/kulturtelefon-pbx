<?php
	...
	//application details
		$apps[$x]['name'] = "Kulturtelefon Theme";
		$apps[$x]['uuid'] = "3a6e3ad5-c7e2-4bdc-9c89-e10047efb953";
		$apps[$x]['category'] = "Theme";
		$apps[$x]['subcategory'] = "";
		$apps[$x]['version'] = "1.0";
		$apps[$x]['license'] = "Mozilla Public License 1.1";
		$apps[$x]['url'] = "https://www.kulturtelefon.de";
		$apps[$x]['description']['en-us'] = "Kulturtelefon theme";
		$apps[$x]['description']['en-gb'] = "Kulturtelefon theme";
		$apps[$x]['description']['ar-eg'] = "";
		$apps[$x]['description']['de-at'] = "Kulturtelefon Theme";
		$apps[$x]['description']['de-ch'] = "";
		$apps[$x]['description']['de-de'] = "Kulturtelefon Theme";

<?php
	...
	//application details
		...
		$apps[$x]['description']['en-us'] = "Gottesdienst Telefon theme";
		$apps[$x]['description']['en-gb'] = "Gottesdienst Telefon theme";
		$apps[$x]['description']['ar-eg'] = "";
		$apps[$x]['description']['de-at'] = "Gottesdienst Telefon Theme";
		$apps[$x]['description']['de-ch'] = "";
		$apps[$x]['description']['de-de'] = "Gottesdienst Telefon Theme";
